...
|
*/
$config['base_url'] = 'http://localhost:90/sipelakor/';
...
|
*/
$config['encryption_key'] = 'sipelakor123';
...
$config['csrf_ajax'] = TRUE;
$config['csrf_exclude_uris'] = array(
    'auth/login',
    'admin/pengeluaran_admin/laporan',
    'kodering/import_excel',
    'pengeluaran/ajax_update',
    'pengeluaran/hapus_ajax'
);
